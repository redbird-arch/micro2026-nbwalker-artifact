...
WORKTREE_PATH = os.path.join(WORKTREE_ROOT, "AE-SnakeByte")
MGPUSIM_PATH = f"{WORKTREE_ROOT}/AE-SnakeByte/simulator/mgpusim/"
...
def main():
    ...
    if args.server:
        generate_runners(name="snakebyte", yaml_path=f"{PROJECT_ROOT}/configs/baselineMMU.yaml", use_amr=False)
        generate_runners(name="snakebyte+nbwalker", yaml_path=f"{PROJECT_ROOT}/configs/nbwalker.yaml", use_amr=True)
    else:
        generate_runners_on_desktop(name="snakebyte", yaml_path=f"{PROJECT_ROOT}/configs/baselineMMU.yaml", use_amr=False)
        generate_runners_on_desktop(name="snakebyte+nbwalker", yaml_path=f"{PROJECT_ROOT}/configs/nbwalker.yaml", use_amr=True)

    ...
    output_df = pd.DataFrame(
        {
            ...
            "SnakeByte+NBWalker+AMR": Opt3["Data"],
        }
    )

    output_path = os.path.join(output_dir, "figure_26.csv")
...
if __name__ == "__main__":
    ...
    for benchmark in get_high_mpki_benchmarks():
        ...
        baseline = append_row(baseline, benchmark, os.path.join(os.environ["PROJECT_ROOT"], "results", "UVM"))
        Opt1     = append_row(Opt1,     benchmark, os.path.join(os.environ["PROJECT_ROOT"], "results", "UVM+SnakeByte"))

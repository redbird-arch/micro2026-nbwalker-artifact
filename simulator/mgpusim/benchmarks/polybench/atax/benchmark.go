...
func (b *Benchmark) exec() {
	...
	localSizeX := 64
	localSize := [3]uint16{uint16(localSizeX), 1, 1}
	globalSizeX := uint32(((b.NX-1)/localSizeX + 1) * localSizeX)
	...
	globalSizeX = uint32(((b.NY-1)/localSizeX + 1) * localSizeX)
	globalSize = [3]uint32{globalSizeX, 1, 1}

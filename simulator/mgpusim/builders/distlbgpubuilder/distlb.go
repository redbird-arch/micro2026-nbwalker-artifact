...
// DisTLBGPUBuilder can build MCM GPUs.
type DisTLBGPUBuilder struct {
	engine                         akita.Engine
	freq                           akita.Freq
...
// MakeDisTLBGPUBuilder provides a GPU builder that can builds the MCM GPU.
func MakeDisTLBGPUBuilder() DisTLBGPUBuilder {
	b := DisTLBGPUBuilder{
		freq:                           1 * akita.GHz,
...
func (b DisTLBGPUBuilder) WithEngine(engine akita.Engine) DisTLBGPUBuilder {
	b.engine = engine
	return b
}

// WithFreq sets the frequency that the GPU works at.
func (b DisTLBGPUBuilder) WithFreq(freq akita.Freq) DisTLBGPUBuilder {
	b.freq = freq
	return b
}

// WithMemAddrOffset sets the address of the first byte of the GPU to build.
func (b DisTLBGPUBuilder) WithMemAddrOffset(
	offset uint64,
) DisTLBGPUBuilder {
...
func (b DisTLBGPUBuilder) WithTotalMem(memory uint64) DisTLBGPUBuilder {
	b.totalMem = memory
	return b
}
...
func (b DisTLBGPUBuilder) WithNumMemoryBankPerChiplet(n int) DisTLBGPUBuilder {
	b.numMemoryBankPerChiplet = n
	return b
}

// WithNumChiplet sets the number of chiplets
func (b DisTLBGPUBuilder) WithNumChiplet(n int) DisTLBGPUBuilder {
	b.numChiplet = n
	return b
}

// WithNumShaderArrayPerChiplet sets the number of shader arrays in each chiplet
func (b DisTLBGPUBuilder) WithNumShaderArrayPerChiplet(n int) DisTLBGPUBuilder {
...
// each Shader Array.
func (b DisTLBGPUBuilder) WithNumCUPerShaderArray(n int) DisTLBGPUBuilder {
...
func (b DisTLBGPUBuilder) WithLog2MemoryBankInterleavingSize(
	n uint64,
) DisTLBGPUBuilder {
...
func (b DisTLBGPUBuilder) WithRemoteTLB(
...
// components
func (b DisTLBGPUBuilder) WithVisTracer(t tracing.Tracer) DisTLBGPUBuilder {
...
func (b DisTLBGPUBuilder) WithTLBTracer(t tracing.Tracer) DisTLBGPUBuilder {
...
func (b DisTLBGPUBuilder) WithMemTracer(t tracing.Tracer) DisTLBGPUBuilder {
...
func (b DisTLBGPUBuilder) WithLog2PageSize(log2PageSize uint64) DisTLBGPUBuilder {
	b.log2PageSize = log2PageSize
	return b
}

// WithPageTable sets the page size with the power of 2.
func (b DisTLBGPUBuilder) WithPageTable(pt *device.PageTableImpl) DisTLBGPUBuilder {
	b.pageTable = pt
	return b
}

// WithAlg sets the scheduling algorithm
func (b DisTLBGPUBuilder) WithAlg(alg string) DisTLBGPUBuilder {
	b.alg = alg
	return b
}

// Use coalesing port?
func (b DisTLBGPUBuilder) UseCoalescingTLBPort() DisTLBGPUBuilder {
...
func (b DisTLBGPUBuilder) CalculateMemoryParameters() DisTLBGPUBuilder {
...
func (b DisTLBGPUBuilder) Build(name string, id uint64) *mgpusim.GPU {
	b.createGPU(name, id)
...
func (b *DisTLBGPUBuilder) createGPU(name string, id uint64) {
	b.gpuName = name
...
func (b *DisTLBGPUBuilder) buildCP() {
...
func (b *DisTLBGPUBuilder) buildDMAEngine() {
...
func (b *DisTLBGPUBuilder) BuildSAs(chiplet *Chiplet) {
...
func (b *DisTLBGPUBuilder) buildSA(
...
func (b *DisTLBGPUBuilder) buildMemBanks(chiplet *Chiplet) {
...
// func (b *DisTLBGPUBuilder) createDRAMControllerBuilder() dram.Builder {
...
func (b *DisTLBGPUBuilder) buildL2TLB(chiplet *Chiplet) {
	numSets := 128
...
func (b *DisTLBGPUBuilder) configChipRDMAEngine(
	chiplet *Chiplet,
...
func (b *DisTLBGPUBuilder) configRemoteAddressTranslationUnit(
	chiplet *Chiplet,
...
func (b *DisTLBGPUBuilder) connectCP() {
...
func (b *DisTLBGPUBuilder) setupMMUs() {
...
func (b *DisTLBGPUBuilder) connectCPWithCUs() {
	for _, chiplet := range b.chiplets {
...
func (b *DisTLBGPUBuilder) connectCPWithAddressTranslators() {
	for _, chiplet := range b.chiplets {
...
func (b *DisTLBGPUBuilder) connectCPWithTLBs() {
	for _, chiplet := range b.chiplets {
...
func (b *DisTLBGPUBuilder) connectCPWithCaches() {
	for _, chiplet := range b.chiplets {
...
func (b *DisTLBGPUBuilder) connectL1ToL2(chiplet *Chiplet) {
...
func (b *DisTLBGPUBuilder) connectL1TLBToL2TLB(chiplet *Chiplet) {
...
func (b *DisTLBGPUBuilder) buildPageMigrationController() {
...
func (b *DisTLBGPUBuilder) setupDMA() {
...
func (b *DisTLBGPUBuilder) setupInterchipNetwork() {
...
func (b *DisTLBGPUBuilder) buildRDMAEngine() {
...
func (b *DisTLBGPUBuilder) createChipRDMAAddrTable() *cache.BankedLowModuleFinder {
...
func (b *DisTLBGPUBuilder) createRemoteAddrTransTable() *cache.InterleavedLowModuleFinder {

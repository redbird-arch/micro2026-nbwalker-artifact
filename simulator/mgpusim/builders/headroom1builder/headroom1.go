...
// Headroom1Builder can build MCM GPUs.
type Headroom1Builder struct {
	engine                         akita.Engine
	freq                           akita.Freq
...
// MakeHeadroom1Builder provides a GPU builder that can builds the MCM GPU.
func MakeHeadroom1Builder() Headroom1Builder {
	b := Headroom1Builder{
		freq:                           1 * akita.GHz,
		...
		remoteTLBInterleavingSize:      32,
	}
	return b
}

// WithEngine sets the engine that the GPU use.
func (b Headroom1Builder) WithEngine(engine akita.Engine) Headroom1Builder {
	b.engine = engine
	return b
}

// WithFreq sets the frequency that the GPU works at.
func (b Headroom1Builder) WithFreq(freq akita.Freq) Headroom1Builder {
	b.freq = freq
	return b
}

// WithMemAddrOffset sets the address of the first byte of the GPU to build.
func (b Headroom1Builder) WithMemAddrOffset(
	offset uint64,
) Headroom1Builder {
...
func (b Headroom1Builder) WithTotalMem(memory uint64) Headroom1Builder {
	b.totalMem = memory
	return b
}
...
// for the GPU.
func (b Headroom1Builder) WithMMU(mmu mmu.MMU) Headroom1Builder {
	b.mmu = mmu
	return b
}
...
func (b Headroom1Builder) WithNumMemoryBankPerChiplet(n int) Headroom1Builder {
	b.numMemoryBankPerChiplet = n
	return b
}

// WithNumChiplet sets the number of chiplets
func (b Headroom1Builder) WithNumChiplet(n int) Headroom1Builder {
	b.numChiplet = n
	return b
}

// WithNumShaderArrayPerChiplet sets the number of shader arrays in each chiplet
func (b Headroom1Builder) WithNumShaderArrayPerChiplet(n int) Headroom1Builder {
...
// each Shader Array.
func (b Headroom1Builder) WithNumCUPerShaderArray(n int) Headroom1Builder {
...
func (b Headroom1Builder) WithLog2MemoryBankInterleavingSize(
	n uint64,
) Headroom1Builder {
...
func (b Headroom1Builder) WithRemoteTLB(
...
// components
func (b Headroom1Builder) WithVisTracer(t tracing.Tracer) Headroom1Builder {
...
func (b Headroom1Builder) WithTLBTracer(t tracing.Tracer) Headroom1Builder {
...
func (b Headroom1Builder) WithMemTracer(t tracing.Tracer) Headroom1Builder {
...
func (b Headroom1Builder) WithLog2PageSize(log2PageSize uint64) Headroom1Builder {
	b.log2PageSize = log2PageSize
	return b
}

// WithPageTable sets the page size with the power of 2.
func (b Headroom1Builder) WithPageTable(pt *device.PageTableImpl) Headroom1Builder {
	b.pageTable = pt
	return b
}
...
func (b Headroom1Builder) CalculateMemoryParameters() Headroom1Builder {
...
func (b Headroom1Builder) Build(name string, id uint64) *mgpusim.GPU {
	b.createGPU(name, id)
...
func (b *Headroom1Builder) createGPU(name string, id uint64) {
	b.gpuName = name
...
func (b *Headroom1Builder) buildCP() {
...
func (b *Headroom1Builder) buildDMAEngine() {
...
func (b *Headroom1Builder) BuildSAs(chiplet *Chiplet) {
...
func (b *Headroom1Builder) buildSA(
...
func (b *Headroom1Builder) buildMemBanks(chiplet *Chiplet) {
...
// func (b *Headroom1Builder) createDRAMControllerBuilder() dram.Builder {
...
func (b *Headroom1Builder) buildL2TLB(chiplet *Chiplet) {
...
func (b *Headroom1Builder) buildMMU(chiplet *Chiplet) {
...
func (b *Headroom1Builder) configChipRDMAEngine(
	chiplet *Chiplet,
...
func (b *Headroom1Builder) configRemoteAddressTranslationUnit(
	chiplet *Chiplet,
...
func (b *Headroom1Builder) connectCP() {
...
func (b *Headroom1Builder) setupMMUs() {
...
func (b *Headroom1Builder) connectCPWithCUs() {
	for _, chiplet := range b.chiplets {
...
func (b *Headroom1Builder) connectCPWithAddressTranslators() {
	for _, chiplet := range b.chiplets {
...
func (b *Headroom1Builder) connectCPWithTLBs() {
	for _, chiplet := range b.chiplets {
...
func (b *Headroom1Builder) connectCPWithCaches() {
	for _, chiplet := range b.chiplets {
...
func (b *Headroom1Builder) connectL1ToL2(chiplet *Chiplet) {
...
func (b *Headroom1Builder) connectL2ToDRAM(chiplet *Chiplet) {
...
func (b *Headroom1Builder) connectL1TLBToL2TLB(chiplet *Chiplet) {
...
func (b *Headroom1Builder) connectL2TLBTOMMU(chiplet *Chiplet) {
...
func (b *Headroom1Builder) buildPageMigrationController() {
...
func (b *Headroom1Builder) setupDMA() {
...
func (b *Headroom1Builder) setupInterchipNetwork() {
...
func (b *Headroom1Builder) setupInterchipMagicNetwork() {
...
func (b *Headroom1Builder) buildRDMAEngine() {
...
func (b *Headroom1Builder) createChipRDMAAddrTable() *cache.BankedLowModuleFinder {
...
func (b *Headroom1Builder) createRemoteAddrTransTable() *cache.InterleavedLowModuleFinder {

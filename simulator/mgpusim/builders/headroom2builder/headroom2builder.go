...
// Headroom2Builder can build MCM GPUs.
type Headroom2Builder struct {
	engine                         akita.Engine
	freq                           akita.Freq
...
// MakeHeadroom2Builder provides a GPU builder that can builds the MCM GPU.
func MakeHeadroom2Builder() Headroom2Builder {
	b := Headroom2Builder{
		freq:                           1 * akita.GHz,
...
func (b Headroom2Builder) WithEngine(engine akita.Engine) Headroom2Builder {
	b.engine = engine
	return b
}

// WithFreq sets the frequency that the GPU works at.
func (b Headroom2Builder) WithFreq(freq akita.Freq) Headroom2Builder {
	b.freq = freq
	return b
}

// WithMemAddrOffset sets the address of the first byte of the GPU to build.
func (b Headroom2Builder) WithMemAddrOffset(
	offset uint64,
) Headroom2Builder {
...
func (b Headroom2Builder) WithTotalMem(memory uint64) Headroom2Builder {
	b.totalMem = memory
	return b
}
...
// for the GPU.
func (b Headroom2Builder) WithMMU(mmu mmu.MMU) Headroom2Builder {
	b.mmu = mmu
	return b
}
...
func (b Headroom2Builder) WithNumMemoryBankPerChiplet(n int) Headroom2Builder {
	b.numMemoryBankPerChiplet = n
	return b
}

// WithNumChiplet sets the number of chiplets
func (b Headroom2Builder) WithNumChiplet(n int) Headroom2Builder {
	b.numChiplet = n
	return b
}

// WithNumShaderArrayPerChiplet sets the number of shader arrays in each chiplet
func (b Headroom2Builder) WithNumShaderArrayPerChiplet(n int) Headroom2Builder {
...
// each Shader Array.
func (b Headroom2Builder) WithNumCUPerShaderArray(n int) Headroom2Builder {
...
func (b Headroom2Builder) WithLog2MemoryBankInterleavingSize(
	n uint64,
) Headroom2Builder {
...
// components
func (b Headroom2Builder) WithVisTracer(t tracing.Tracer) Headroom2Builder {
...
func (b Headroom2Builder) WithMemTracer(t tracing.Tracer) Headroom2Builder {
...
// WithMemTracer applies a tracer to trace the memory transactions.
func (b Headroom2Builder) WithTLBTracer(t tracing.Tracer) Headroom2Builder {
...
func (b Headroom2Builder) WithLog2PageSize(log2PageSize uint64) Headroom2Builder {
	b.log2PageSize = log2PageSize
	return b
}

// WithPageTable sets the page size with the power of 2.
func (b Headroom2Builder) WithPageTable(pt *device.PageTableImpl) Headroom2Builder {
	b.pageTable = pt
	return b
}
...
func (b Headroom2Builder) CalculateMemoryParameters() Headroom2Builder {
...
func (b Headroom2Builder) Build(name string, id uint64) *mgpusim.GPU {
	b.createGPU(name, id)

	b.buildCP()

	chipRdmaAddressTable := b.createChipRDMAAddrTable()
	chipRdmaResponsePorts := make([]akita.Port, 4)
	...
	for i := 0; i < b.numChiplet; i++ {
		...
		b.configChipRDMAEngine(chiplet, chipRdmaAddressTable, chipRdmaResponsePorts)
...
func (b *Headroom2Builder) createGPU(name string, id uint64) {
	b.gpuName = name
...
func (b *Headroom2Builder) buildCP() {
...
func (b *Headroom2Builder) buildDMAEngine() {
...
func (b *Headroom2Builder) BuildSAs(chiplet *Chiplet) {
...
func (b *Headroom2Builder) buildSA(
...
func (b *Headroom2Builder) buildMemBanks(chiplet *Chiplet) {
...
// func (b *Headroom2Builder) createDRAMControllerBuilder() dram.Builder {
...
func (b *Headroom2Builder) buildL2TLB(chiplet *Chiplet) {
...
func (b *Headroom2Builder) configChipRDMAEngine(
	chiplet *Chiplet,
	addrTable *cache.BankedLowModuleFinder, chipRdmaResponsePorts []akita.Port) {
	...
	chipRdmaResponsePorts[chiplet.ChipletID] = chiplet.chipRdmaEngine.ResponsePort
	chiplet.chipRdmaEngine.ResponsePorts = chipRdmaResponsePorts
...
func (b *Headroom2Builder) configPageRDMAEngine(
	chiplet *Chiplet,
	addrTable *cache.BankedLowModuleFinder, pageRdmaResponsePorts []akita.Port) {
...
func (b *Headroom2Builder) configRemoteAddressTranslationUnit(
	chiplet *Chiplet,
...
func (b *Headroom2Builder) connectCP() {
...
func (b *Headroom2Builder) setupMMUs() {
...
func (b *Headroom2Builder) connectCPWithCUs() {
	for _, chiplet := range b.chiplets {
...
func (b *Headroom2Builder) connectCPWithAddressTranslators() {
	for _, chiplet := range b.chiplets {
...
func (b *Headroom2Builder) connectCPWithTLBs() {
	for _, chiplet := range b.chiplets {
...
func (b *Headroom2Builder) connectCPWithCaches() {
	for _, chiplet := range b.chiplets {
...
func (b *Headroom2Builder) connectL1ToL2(chiplet *Chiplet) {
...
func (b *Headroom2Builder) connectMMUToL2(chiplet *Chiplet) {
...
func (b *Headroom2Builder) connectL1TLBToL2TLB(chiplet *Chiplet) {
...
func (b *Headroom2Builder) buildPageMigrationController() {
...
func (b *Headroom2Builder) setupDMA() {
...
func (b *Headroom2Builder) setupInterchipNetwork() {
...
func (b *Headroom2Builder) createChipRDMAAddrTable() *cache.BankedLowModuleFinder {
...
func (b *Headroom2Builder) createRemoteAddrTransTable() *cache.InterleavedLowModuleFinder {
	return nil
}

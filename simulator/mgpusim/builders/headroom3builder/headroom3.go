...
// Headroom3Builder can build MCM GPUs.
type Headroom3Builder struct {
	engine                         akita.Engine
	freq                           akita.Freq
...
// MakeHeadroom3Builder provides a GPU builder that can builds the MCM GPU.
func MakeHeadroom3Builder() Headroom3Builder {
	b := Headroom3Builder{
		freq:                           1 * akita.GHz,
...
func (b Headroom3Builder) WithEngine(engine akita.Engine) Headroom3Builder {
	b.engine = engine
	return b
}

// WithFreq sets the frequency that the GPU works at.
func (b Headroom3Builder) WithFreq(freq akita.Freq) Headroom3Builder {
	b.freq = freq
	return b
}

// WithMemAddrOffset sets the address of the first byte of the GPU to build.
func (b Headroom3Builder) WithMemAddrOffset(
	offset uint64,
) Headroom3Builder {
...
func (b Headroom3Builder) WithTotalMem(memory uint64) Headroom3Builder {
	b.totalMem = memory
	return b
}
...
// for the GPU.
func (b Headroom3Builder) WithMMU(mmu mmu.MMU) Headroom3Builder {
	b.mmu = mmu
	return b
}
...
func (b Headroom3Builder) WithNumMemoryBankPerChiplet(n int) Headroom3Builder {
	b.numMemoryBankPerChiplet = n
	return b
}

// WithNumChiplet sets the number of chiplets
func (b Headroom3Builder) WithNumChiplet(n int) Headroom3Builder {
	b.numChiplet = n
	return b
}

// WithNumShaderArrayPerChiplet sets the number of shader arrays in each chiplet
func (b Headroom3Builder) WithNumShaderArrayPerChiplet(n int) Headroom3Builder {
...
// each Shader Array.
func (b Headroom3Builder) WithNumCUPerShaderArray(n int) Headroom3Builder {
...
func (b Headroom3Builder) WithLog2MemoryBankInterleavingSize(
	n uint64,
) Headroom3Builder {
...
func (b Headroom3Builder) WithRemoteTLB(
...
// components
func (b Headroom3Builder) WithVisTracer(t tracing.Tracer) Headroom3Builder {
...
func (b Headroom3Builder) WithTLBTracer(t tracing.Tracer) Headroom3Builder {
...
func (b Headroom3Builder) WithMemTracer(t tracing.Tracer) Headroom3Builder {
...
func (b Headroom3Builder) WithLog2PageSize(log2PageSize uint64) Headroom3Builder {
	b.log2PageSize = log2PageSize
	return b
}

// WithPageTable sets the page size with the power of 2.
func (b Headroom3Builder) WithPageTable(pt *device.PageTableImpl) Headroom3Builder {
	b.pageTable = pt
	return b
}

func (b Headroom3Builder) WithAlg(alg string) Headroom3Builder {
	b.alg = alg
	return b
}
...
func (b Headroom3Builder) CalculateMemoryParameters() Headroom3Builder {
...
func (b Headroom3Builder) Build(name string, id uint64) *mgpusim.GPU {
	b.createGPU(name, id)
...
func (b *Headroom3Builder) createGPU(name string, id uint64) {
	b.gpuName = name
...
func (b *Headroom3Builder) buildCP() {
...
func (b *Headroom3Builder) buildDMAEngine() {
...
func (b *Headroom3Builder) BuildSAs(chiplet *Chiplet) {
...
func (b *Headroom3Builder) buildSA(
...
func (b *Headroom3Builder) buildMemBanks(chiplet *Chiplet) {
...
// func (b *Headroom3Builder) createDRAMControllerBuilder() dram.Builder {
...
func (b *Headroom3Builder) buildL2TLB(chiplet *Chiplet) {
...
func (b *Headroom3Builder) buildMMU(chiplet *Chiplet) {
...
func (b *Headroom3Builder) configChipRDMAEngine(
	chiplet *Chiplet,
...
func (b *Headroom3Builder) connectCP() {
...
func (b *Headroom3Builder) setupMMUs() {
...
func (b *Headroom3Builder) connectCPWithCUs() {
	for _, chiplet := range b.chiplets {
...
func (b *Headroom3Builder) connectCPWithAddressTranslators() {
	for _, chiplet := range b.chiplets {
...
func (b *Headroom3Builder) connectCPWithTLBs() {
	for _, chiplet := range b.chiplets {
...
func (b *Headroom3Builder) connectCPWithCaches() {
	for _, chiplet := range b.chiplets {
...
func (b *Headroom3Builder) connectL1ToL2(chiplet *Chiplet) {
...
func (b *Headroom3Builder) connectL2ToDRAM(chiplet *Chiplet) {
...
func (b *Headroom3Builder) connectL1TLBToL2TLBMagic() {
...
func (b *Headroom3Builder) connectL2TLBTOMMU(chiplet *Chiplet) {
...
func (b *Headroom3Builder) buildPageMigrationController() {
...
func (b *Headroom3Builder) setupDMA() {
...
func (b *Headroom3Builder) setupInterchipNetwork() {
...
func (b *Headroom3Builder) buildRDMAEngine() {
...
func (b *Headroom3Builder) createChipRDMAAddrTable() *cache.BankedLowModuleFinder {
...
func (b *Headroom3Builder) createRemoteAddrTransTable() *cache.InterleavedLowModuleFinder {

...
// MOD TLB specific function

// MakeMODTLBGPUBuilder provides a GPU builder that can builds MCM GPU.
func MakeMODTLBGPUBuilder() MODTLBGPUBuilder {
	// TODO: should this be using new? is the object being allocated on the stack?
	cbp := CommonBuilder{}
	b := MODTLBGPUBuilder{CommonBuilder: &cbp, switchL2TLBStriping: false, usePtCaching: false}
	b.SetDefaultCommonBuilderParams()
	return b
}

func (b MODTLBGPUBuilder) Build(name string, id uint64) *mgpusim.GPU {
...
func (b *MODTLBGPUBuilder) createRemoteAddrTransTable() *cache.InterleavedLowModuleFinder {
...
func (b *MODTLBGPUBuilder) configRemoteAddressTranslationUnit(chiplet *Chiplet,
...
func (b *MODTLBGPUBuilder) connectL1TLBToL2TLB(chiplet *Chiplet) {
...
func (b *MODTLBGPUBuilder) SwitchL2TLBStriping(switchStriping bool) {
	b.switchL2TLBStriping = switchStriping
}

func (b *MODTLBGPUBuilder) UsePtCaching(ptCaching bool) {
	b.usePtCaching = ptCaching
}

func (b *MODTLBGPUBuilder) connectMMUToL2(chiplet *Chiplet) {
...
func (b *MODTLBGPUBuilder) buildMemBanks(chiplet *Chiplet) {
	...
	for i := 0; i < b.numMemoryBankPerChiplet; i++ {
		...
		lowModuleFinder := cache.NewStripedLocalVRemoteLowModuleFinder(b.memAddrOffset, 32,
...
func (b *MODTLBGPUBuilder) connectL2ToDRAM(chiplet *Chiplet) {

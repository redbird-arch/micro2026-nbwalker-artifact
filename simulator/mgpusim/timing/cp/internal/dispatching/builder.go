...
func (b Builder) WithSchedulingPartition(partition string) Builder {
...
func (b Builder) Build(name string) Dispatcher {
	...
	case "chiplet-aware":
		d.alg = &chipletAwareAlgorithm{
			gridBuilder: kernels.NewGridBuilder(),
			cuPool:      b.cuResourcePool,
		}
	case "old-chiplet-aware":
		d.alg = &oldChipletAwareAlgorithm{
			gridBuilder: kernels.NewGridBuilder(),
			cuPool:      b.cuResourcePool,
		}
	case "greedy":
